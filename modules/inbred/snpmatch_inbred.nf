...
workflow SNPMATCH_INBRED {
    ...
    out_csv = make_csv_inbred( identify_libs.snpmatch_out.collect(), output_folder )
...
process make_csv_inbred {
    ...
    """
    python $workflow.projectDir/makeCSVTable_inbred.py --dirs -i ./ -o intermediate_modified.csv -f $output_id
    """
}
